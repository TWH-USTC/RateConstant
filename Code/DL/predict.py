...
if __name__ == '__main__':
    ...
    for name in name_list:
        for seed in [0, 1, 2, 3, 4]:
            ...
            test_data_path = f'./data/typical.csv'
            ...
            if args.atom_features_type == 'base':
                ...
                mapping_smiles_to_embedding_test = get_smi_to_embedding_map('typical', args.atom_features_type)
                func_smi_to_repr = lambda smi: (mapping_smiles_to_embedding_test[smi] - average[None, :])/std[None, :]
            ...
            torch.save(test_data, f"Result/infos/test-typical-{name}-{seed}.pt")